...
// Configurazione della connessione al database con SSL (richiesto da Supabase)[cite: 1]
const pool = new Pool({
    connectionString: process.env.DATABASE_URL,
    ssl: { rejectUnauthorized: false }
});

// Inizializzazione delle tabelle nel database[cite: 1]
...
// Serve i file statici del frontend (es. index.html nella stessa cartella o in una sottocartella 'public')
